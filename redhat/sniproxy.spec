...
BuildRequires: autoconf, automake, curl, libev-devel, pcre2-devel, gettext-devel, c-ares-devel, openssl-devel, libbsd-devel, libseccomp-devel, systemd-rpm-macros
